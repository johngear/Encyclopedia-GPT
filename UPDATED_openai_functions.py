...
def UPDATE_order_document_sections_by_query_similarity(query: str, contexts):
...
def UPDATE_construct_prompt(question: str, context_embeddings: dict, df: pd.DataFrame):
    """
    Fetch relevant 
    """
    ...
    most_relevant_document_sections = UPDATE_order_document_sections_by_query_similarity(question, context_embeddings)
